...
func ProbeICMP(ctx context.Context, target string, module config.Module, registry *prometheus.Registry, logger log.Logger) (success bool) {
	...
	socket, requestType, replyType, err := getICMPSocket(module.ICMP, ip, registry, logger)
	if err != nil {
...
func getICMPSocket(
	cfg config.ICMPProbe,
	ip *net.IPAddr,
	registry *prometheus.Registry,
	logger log.Logger) (socket net.PacketConn, requestType icmp.Type, replyType icmp.Type, err error) {
