...
State {
    ...
    ctx: {
        ...
        "Name": "dns.lookup.time.seconds",
        "Type": "DnsLookupTimeSeconds",
        "ctx": {
            "attributes": [],
            "brief": "Returns the time taken for probe dns lookup in seconds",
            "events": [],
            "id": "metric.probe.dns.lookup.time.seconds",
            "instrument": "gauge",
            "lineage": {
                "provenance": {
            ...
            "metric_name": "probe_dns_lookup_time_seconds",
            "name": none,
