...
State {
    ...
    ctx: {
        ...
        "Name": "probe.expect.info",
        "Type": "ProbeExpectInfo",
        "ctx": {
            "attributes": [],
            "brief": "Explicit content matched",
            "events": [],
            "id": "metric.tcp.probe.expect.info",
            "instrument": "gauge",
            "lineage": {
                "provenance": {
                    "path": "../../semconv/tcp/metrics.yaml",
                    "registry_id": "main",
                },
            },
            "metric_name": "probe_expect_info",
            "name": none,
            "note": "This metric uses dynamic labels based on the TCP module configuration",
            "root_namespace": "tcp",
            "span_kind": none,
            "stability": "stable",
            "type": "metric",
