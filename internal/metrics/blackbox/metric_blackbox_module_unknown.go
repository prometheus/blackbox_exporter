...
State {
    ...
    ctx: {
        ...
        "ctx": {
            "attributes": [],
            "brief": "Count of unknown modules requested by probes",
            "events": [],
            "id": "metric.blackbox.module.unknown",
            "instrument": "counter",
            "lineage": {
                "provenance": {
                    "path": "../../semconv/blackbox/metrics.yaml",
                    "registry_id": "main",
                },
            },
            "metric_name": "blackbox_module_unknown_total",
            "name": none,
            "root_namespace": "blackbox",
            "span_kind": none,
            "stability": "stable",
            "type": "metric",
            "unit": "1",
