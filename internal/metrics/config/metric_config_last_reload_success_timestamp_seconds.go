...
State {
    ...
    ctx: {
        ...
        "Name": "last.reload.success.timestamp.seconds",
        "Type": "LastReloadSuccessTimestampSeconds",
        "ctx": {
            "attributes": [],
            "brief": "Timestamp of the last successful configuration reload",
            "events": [],
            "id": "metric.config.last.reload.success.timestamp.seconds",
            "instrument": "gauge",
            "lineage": {
                "provenance": {
                    "path": "../../semconv/config/metrics.yaml",
                    "registry_id": "main",
                },
            },
            "metric_name": "blackbox_exporter_config_last_reload_success_timestamp_seconds",
            "name": none,
            "root_namespace": "config",
            "span_kind": none,
            "stability": "stable",
            "type": "metric",
            "unit": "s",
